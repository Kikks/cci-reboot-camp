      ...
      <div className="md:mx-auto md:w-[80%]">
        ...
        <div className="px-6 pb-12 text-center md:pb-0">
          <div className="text-[1em] md:mx-auto md:text-[1.25em]">
            <p>
              You deserve the best experience at the Global Reboot Camp 2022 and for that reason we
              have decided to give you the opportunity to both register for the camp meeting as well
              as book your accommodation.
            </p>
            <div className="relative -mx-6 flex items-center py-4 md:hidden">
              <span className="absolute right-[7%] h-[23px] w-[18px]">{Star5}</span>
              <span className="absolute right-0 mb-8 h-[39px] w-[31px]">{Star6}</span>
            </div>
            <p className="md:mt-2">
              <span className="font-bold">P:S-</span> After registering and booking your
              accommodation you will be granted FREE transportation from your campus to the venue!
            </p>
          </div>
