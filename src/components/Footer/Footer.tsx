				...
				<div className=' my-[50px] grid justify-items-center px-[20px] sm:flex sm:justify-between'>
					...
					<div className='mt-[15px] flex w-[250px] justify-between sm:mt-0'>
						<a
							target='_blank'
							rel='noreferrer'
							href='https://web.facebook.com/CelebrationChurchIntl/'
						>
						...
						<a
							target='_blank'
							rel='noreferrer'
							href='https://instagram.com/cci_therebootcamp?igshid=YmMyMTA2M2Y='
						>
						...
						<a
							target='_blank'
							rel='noreferrer'
							href='https://twitter.com/cci__global'
						>
						...
						<a
							target='_blank'
							rel='noreferrer'
							href='https://www.youtube.com/c/CelebrationChurchNG'
						>
